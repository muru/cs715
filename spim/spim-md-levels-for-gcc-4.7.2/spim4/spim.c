...
conditional_insn(enum rtx_code code,rtx operands[], int isRev)
{
	...
	else /*Reverse condition*/
	{
	    switch(code)
            {
                case EQ:return "bne %1, %2, %l0";
                case NE:return "beq %1, %2, %l0";
                case GE:return "blt %1, %2, %l0";
                case GT:return "ble %1, %2, %l0";
                case LT:return "bge %1, %2, %l0";
                case LE:return "bgt %1, %2, %l0";
                case GEU:return "bltu %1, %2, %l0";
                case GTU:return "bleu %1, %2, %l0";
                case LTU:return "bgeu %1, %2, %l0";
                case LEU:return "bgtu %1, %2, %l0";
            }
	}
}
